...
| GEX study — user guide to Levels, Profile, Bands and Heatmap: GEX vs DEX, OI vs volume weighting, walls, Zero-Gamma, Regime vs Sentiment, and what stopping the recording does | [gex-levels-reading.md](gex-levels-reading.md) |
